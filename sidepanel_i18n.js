(function installQCI18n(root) {
  ...
  const catalogs = {
    en: {
      ...
      "selectionSave.pending": "The selected text is queued. Test the local Companion in Settings to save it as pending evidence; no model will be called.",
      "selectionSave.updateCompanion": "Not saved yet—update Companion to the same release as extension {extensionVersion}, then test it again. Companion {serviceVersion} does not support local Selection First Evidence; the selection remains queued.",
      "selectionSave.saving": "Saving the selected text locally as pending evidence; no model is being called...",
      "selectionSave.saved": "Saved locally as pending First Evidence. It is ready for your review, and no model was called.",
      "selectionSave.savedPendingAck": "First Evidence was saved locally, but the pending queue could not be cleared. It will be safely retried without creating a duplicate.",
      "selectionSave.notSaved": "The selection was not saved and remains queued: {error}",
      "selectionSave.tooLong": "This selection is {length} characters; the local evidence limit is {max}. Choose a shorter selection and try again. Nothing was queued or truncated.",
      "selectionSave.failed.ambiguous_quote": "The selection was not saved because the exact quote appears more than once in the captured context. It remains queued; choose a more distinctive passage.",
      "selectionSave.failed.quote_mismatch": "The selection was not saved because the exact quote was not found in the captured context. It remains queued; select the passage again.",
      "selectionSave.failed.quote_too_long": "The selection exceeds the local evidence limit and was not saved. Choose a shorter passage; it was not truncated.",
      "selectionSave.failed.project_mismatch": "The selection was not saved because its project changed. It remains isolated in its original project queue.",
      "selectionSave.failed.source_superseded": "The selection was not saved because the captured source was superseded. It remains queued for a fresh retry.",
      "selectionSave.failed.missing_chunk": "The selection was not saved because the local capture has no evidence chunk. It remains queued.",
      "selectionSave.failed.authentication_lost": "The selection was not saved because Companion authentication was lost. It remains queued; test the local Companion again.",
      "selectionSave.failed.invalid_first_evidence_response": "The selection was not acknowledged because the local First Evidence response could not be verified. It remains queued.",
      ...
      "replay.actionLabel": "Replay evidence from {source} at {locator}",
      "replay.panelLabel": "Captured evidence replay",
      "replay.status.resolved": "Captured snapshot verified",
      "replay.status.stale": "Source changed; showing the captured snapshot",
      "replay.status.unresolved": "Exact locator unresolved; showing the captured record only",
      "replay.snapshotTitle": "Captured context",
      "replay.storedQuote": "Stored exact quote",
      "replay.kind.page": "Web",
      "replay.kind.pdf": "PDF",
      "replay.kind.thread": "Forum",
      "replay.kind.video": "YouTube",
      "replay.kind.source": "Source",
      "replay.locator.page": "Page {value}",
      "replay.locator.floor": "Floor {value}",
      "replay.locator.timestamp": "Time {value}",
      "replay.locator.chunk": "Chunk {value}",
      "replay.locator.provenance": "Provenance {value}",
      "replay.locator.unknown": "saved locator",
      "replay.source.captured": "Captured {value}",
      "replay.source.version": "Version {value}",
      "replay.source.hash": "Content hash {value}",
      "replay.source.current": "Current captured version",
      "replay.source.superseded": "Superseded by {sourceId}",
      "replay.source.open": "Open canonical source",
      "replay.source.unknown": "captured source",
      "replay.source.fallback": "Opens the canonical source only; a precise remote position is not guaranteed.",
      "replay.reason.exact_quote_match": "Exact quote matched in the captured context.",
      "replay.reason.source_superseded": "The captured source has a newer version.",
      "replay.reason.missing_source": "The captured source record is missing.",
      "replay.reason.missing_chunk": "The captured chunk is missing.",
      "replay.reason.chunk_source_mismatch": "The captured chunk belongs to a different source.",
      "replay.reason.missing_quote": "The evidence has no stored exact quote.",
      "replay.reason.quote_mismatch": "The stored exact quote does not match the captured context.",
      "replay.reason.quote_too_long": "The stored exact quote exceeds the replay matching limit, so its precise occurrence is unresolved.",
      "replay.reason.ambiguous_quote": "The stored exact quote appears more than once; the precise occurrence is unresolved.",
      "replay.reason.project_mismatch": "Evidence belongs to another project; source details are hidden.",
      "replay.reason.context_offset_mismatch": "The exact quote is not present verbatim at the supplied captured-context offsets.",
      ...
      "settings.setup.downloadPrompt": "Install the matching local Companion before pairing:",
      "settings.setup.downloadCompanion": "Download Companion v{version}",
      "settings.setup.downloadChecksums": "Verify SHA256SUMS",
      ...
      "settings.status.startupFailed": "Startup could not finish: {error}. Settings remain available; fix the problem and reopen the side panel.",
    ...
    "zh-CN": {
      ...
      "selectionSave.pending": "选中文本已保留在队列中。请先在设置里测试本地 Companion；配对成功后会保存为待核验证据，且不调用模型。",
      "selectionSave.updateCompanion": "尚未保存—请把 Companion 更新到与扩展 {extensionVersion} 相同的发布版，然后重新测试本地服务。当前 Companion {serviceVersion} 不支持本地 Selection First Evidence，选中内容仍保留在队列中。",
      "selectionSave.saving": "正在把选中文本仅保存在本地并生成待核验证据；不会调用模型...",
      "selectionSave.saved": "已在本地保存为待核验的 First Evidence，可以开始核对；全程未调用模型。",
      "selectionSave.savedPendingAck": "First Evidence 已保存在本地，但待处理队列暂未清除；下次会幂等重试，不会重复创建。",
      "selectionSave.notSaved": "本次选择未保存，仍保留在队列中：{error}",
      "selectionSave.tooLong": "本次选择为 {length} 个字符，本地证据上限为 {max}。请缩短并重新选择；内容未入队，也没有被静默截断。",
      "selectionSave.failed.ambiguous_quote": "本次选择未保存：exact quote 在捕获上下文中出现多次，无法唯一定位。内容仍在队列中，请重新选择更有辨识度的片段。",
      "selectionSave.failed.quote_mismatch": "本次选择未保存：捕获上下文中找不到一字不差的 exact quote。内容仍在队列中，请重新选择。",
      "selectionSave.failed.quote_too_long": "本次选择超过本地证据上限，未保存也未截断；请缩短后重新选择。",
      "selectionSave.failed.project_mismatch": "本次选择未保存：当前项目已经变化；它仍隔离保留在原项目队列中。",
      "selectionSave.failed.source_superseded": "本次选择未保存：捕获来源已被新版本取代；内容仍在队列中，可重新捕获。",
      "selectionSave.failed.missing_chunk": "本次选择未保存：本地捕获中没有可绑定的证据 chunk；内容仍在队列中。",
      "selectionSave.failed.authentication_lost": "本次选择未保存：Companion 鉴权已失效。内容仍在队列中，请重新测试本地服务。",
      "selectionSave.failed.invalid_first_evidence_response": "本次选择未确认：本地 First Evidence 响应未通过关系与 Replay 校验；内容仍在队列中。",
      ...
      "replay.action": "Replay",
      "replay.actionLabel": "回放 {source} 在 {locator} 的证据",
      "replay.panelLabel": "已捕获证据回放",
      "replay.status.resolved": "已核验捕获快照",
      "replay.status.stale": "来源已变更；正在显示捕获时快照",
      "replay.status.unresolved": "精确定位未解析；仅显示已捕获记录",
      "replay.snapshotTitle": "捕获时上下文",
      "replay.storedQuote": "已保存的 exact quote",
      "replay.kind.page": "网页",
      "replay.kind.pdf": "PDF",
      "replay.kind.thread": "论坛",
      "replay.kind.video": "YouTube",
      "replay.kind.source": "来源",
      "replay.locator.page": "第 {value} 页",
      "replay.locator.floor": "第 {value} 楼",
      "replay.locator.timestamp": "时间 {value}",
      "replay.locator.chunk": "Chunk {value}",
      "replay.locator.provenance": "定位依据 {value}",
      "replay.locator.unknown": "已保存定位",
      "replay.source.captured": "捕获于 {value}",
      "replay.source.version": "版本 {value}",
      "replay.source.hash": "内容哈希 {value}",
      "replay.source.current": "当前捕获版本",
      "replay.source.superseded": "已被 {sourceId} 取代",
      "replay.source.open": "打开 canonical 来源",
      "replay.source.unknown": "已捕获来源",
      "replay.source.fallback": "仅打开 canonical 来源；不保证能精确跳到远程原文位置。",
      "replay.reason.exact_quote_match": "exact quote 已在捕获时上下文中精确匹配。",
      "replay.reason.source_superseded": "该捕获来源已有新版本。",
      "replay.reason.missing_source": "捕获来源记录缺失。",
      "replay.reason.missing_chunk": "捕获 chunk 缺失。",
      "replay.reason.chunk_source_mismatch": "捕获 chunk 属于另一个来源。",
      "replay.reason.missing_quote": "该 evidence 没有已保存的 exact quote。",
      "replay.reason.quote_mismatch": "已保存的 exact quote 与捕获时上下文不匹配。",
      "replay.reason.quote_too_long": "已保存的 exact quote 超过 Replay 匹配上限，无法确定精确位置。",
      "replay.reason.ambiguous_quote": "已保存的 exact quote 出现多次，无法确定精确位置。",
      "replay.reason.project_mismatch": "证据属于另一个项目；来源详情已隐藏。",
      "replay.reason.context_offset_mismatch": "指定的捕获上下文偏移中没有一字不差的 exact quote。",
      ...
      "settings.setup.downloadPrompt": "配对前，请先安装与扩展同版本的本地 Companion：",
      "settings.setup.downloadCompanion": "下载 Companion v{version}",
      "settings.setup.downloadChecksums": "校验 SHA256SUMS",
      ...
      "settings.status.startupFailed": "启动未完成：{error}。设置仍可操作；修正问题后请重新打开侧边栏。",
